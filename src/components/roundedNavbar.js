                    ...
                    <nav className="w-full flex items-center justify-between p-2 px-4">
                        ...
                        <div className="flex lg:flex-1">
                            <Link href={"/"} className='flex flex-row items-center gap-4'>
                                ...
                                <h2 className='font-bold font-headings text-xl'>BonzaBoost</h2>
                            </Link>
                        </div>
                        ...
                        {links && (
                            <div className="hidden lg:flex lg:flex-1 lg:justify-end font-headings">
                                <Link href={'https://discord.gg/Bonza'} target='_blank' className="font-medium text-lg px-6 py-2 rounded-full bg-nitroPink hover:bg-dMode transition ease-in duration-200">
                                    Join the Discord
                                </Link>
                            </div>
                        )}
